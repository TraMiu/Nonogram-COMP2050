...
class MyDialog:
    ...
    def choose_dimensions(self):
        ...
        # Create button.
        btn = tk.Button(top, text="Start Generate", command = set_grid_from_dimensions)
...
"""
grid is defined as a global variable in this file picross.py
"""
grid = None
max_volume = 0.15
puzzle_check_time = 0
...
"""
constants for easy manipulations for every screen.
"""
GRID_WIDTH = None
GRID_HEIGHT = None
CLUES_WIDTH = None
...
"""
note that to undo and redo move, we are setting the grid.data[y][x].state to different state
this may be helpful to malnipulate the later thing.
"""
def redo_move():
...
# GAME LOOP:
"""
This game loop is very important, we need it to be update the ui constantly and step by steps
May need to use the time.time() to to solve this step by step
"""
running = True
while(running):
